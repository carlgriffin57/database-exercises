...
ORDER BY first_name;     -- Irena	Reutenauer, Vidya	Simmen   709 rows returned.
...
FROM employees 
WHERE first_name IN ('Irena', 'Vidya', 'Maya')
ORDER BY first_name, last_name; -- Irena	Acton, Vidya	Zweizig, 709 rows returned.
...
FROM employees 
WHERE first_name IN ('Irena', 'Vidya', 'Maya')
ORDER BY last_name, first_name;  -- Irena	Acton, Maya	Zyda  709 records returned.
...
ORDER BY emp_no;  -- Ramzi	Erde	10021, Tadahiro	Erde	499648, 899 rows returned.
...
FROM employees 
WHERE last_name LIKE 'e%e'
ORDER BY hire_date DESC; -- Teiji	Eldridge	1999-11-27, Sergi	Erde	1985-02-02, 899 rows returned.

-- 7. Find all employees hired in the 90s and born on Christmas. Sort the results so that the oldest employee who was hired last is the first result. Enter a comment with the number of employees returned, the name of the oldest employee who was hired last, and the name of the youngest emmployee who was hired first.
SELECT  *
FROM employees 
WHERE birth_date LIKE '%12-25'
ORDER BY birth_date, hire_date; -- 252514	1952-12-25	Tsutomu	Kemmerer	M	1985-02-19, 451819	1964-12-25	Gudjon	Vakili	M	1996-08-21, 842 rows returned.
