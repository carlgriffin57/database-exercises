...
SELECT  DATEDIFF(CURDATE(), hire_date) AS diffdate, first_name, last_name
FROM employees 
...
-- 6. Use your knowledge of built in SQL functions to generate a username for all of the employees. A username should be all lowercase, and 
